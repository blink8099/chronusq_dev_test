...
namespace ChronusQ {
  ...
  void InCore4indexERI<dcomplex>::computeERINR(BasisSet &basisSet, Molecule&,
    ...
    if (options.basisType == REAL_GTO)
      CErr("Real GTOs are not allowed in InCore4indexERI<dcomplex>",std::cout);
    if (options.basisType == COMPLEX_GTO)
      CErr("Complex GTOs NYI in InCore4indexERI<dcomplex>",std::cout);
...
// SS: end
    ...
    InCore4indexERI<dcomplex> &eri4I = *this;

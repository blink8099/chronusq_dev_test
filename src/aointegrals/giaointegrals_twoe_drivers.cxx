...
namespace ChronusQ {
   ...
   */ 
  void GIAOIntegrals::computeERI(EMPerturbation &emPert) {
    computeERIGIAO(emPert);
  };
  ...
  void GIAOIntegrals::computeERIGIAO(EMPerturbation &emPert) {

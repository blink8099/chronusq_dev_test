...
// SS end
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLLSF94 =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLLSO103 =
        { {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLLSO104106 =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+1].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer()},
          {contract1PDMSS.S().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL114 =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+10].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer()},
          {contract1PDMSS.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+8].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL115 =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+4].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+6].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL116 =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+4].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+8].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSSSF118 =
        { {contract1PDMLL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), 1},
          {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef].pointer(), 1},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef].pointer(), 1},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef].pointer(), 1} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSSSO119 =
        { {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), 1},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), 1},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(), 1} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSSSO120122 =
        { {contract1PDMLL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+1].pointer(), 1},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer(), 1},
          {contract1PDMLL.S().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer(), 1} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS129 =
        { {contract1PDMLL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), TRANS_MNKL},
          {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_MNKL},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_MNKL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_MNKL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS130 =
        { {contract1PDMLL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+10].pointer(), TRANS_MNKL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(),  TRANS_MNKL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_MNKL},
          {contract1PDMLL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_MNKL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS131 =
        { {contract1PDMLL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer(), TRANS_MNKL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(),  TRANS_MNKL},
          {contract1PDMLL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_MNKL},
          {contract1PDMLL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer(),  TRANS_MNKL}};
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS132 =
        { {contract1PDMLL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer(), TRANS_MNKL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer(),  TRANS_MNKL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+4].pointer(),  TRANS_MNKL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_MNKL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSF91136 =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef].pointer()},
          {contract1PDMSL.S().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSF140 =
        { {contract1PDMSL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), 2},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef].pointer(), 2},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef].pointer(), 2},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO91 =
        { {contract1PDMLS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+1].pointer()},
          {contract1PDMLS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+2].pointer()},
          {contract1PDMLS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO92 =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+1].pointer()},
          {contract1PDMLS.S().pointer(), Scr2, true, COULOMB, relERI[nERIRef+2].pointer()},
          {contract1PDMLS.S().pointer(), Scr3, true, COULOMB, relERI[nERIRef+3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO136 =
        { {contract1PDMSL.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+1].pointer(), 2},
          {contract1PDMSL.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+2].pointer(), 2},
          {contract1PDMSL.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+3].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO137 =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+1].pointer(), 2},
          {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+2].pointer(), 2},
          {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+3].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO150 =
        { {contract1PDMSL.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), 2},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO151 =
        { {contract1PDMSL.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(), 2},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLSSO152 =
        { {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(), 2},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+1].pointer(), 2} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92AX =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+1].pointer()},
          {contract1PDMLS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92BX =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+13].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+5].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+7].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92AY =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+2].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92BY =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+14].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+16].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+9].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92AZ =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+3].pointer()},
          {contract1PDMLS.Z().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS92BZ =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+15].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+17].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+18].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS136 =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+3].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137AX =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137BX =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+13].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+5].pointer(),  TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+7].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137AY =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137BY =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+14].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+16].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+9].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137AZ =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr2, true, COULOMB, relERI[nERIRef].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS137BZ =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+15].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+17].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+18].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS159 =
        { {contract1PDMSL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS160A =
        { {contract1PDMSL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS160B =
        { {contract1PDMSL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+10].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS161A =
        { {contract1PDMSL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS161B =
        { {contract1PDMSL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(),  TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS162A =
        { {contract1PDMSL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS162B =
        { {contract1PDMSL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(),  TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_KL} };
    ...
    if(this->hamiltonianOptions_.DiracCoulombSSSS) {//Dirac-Coulomb-SSSS
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70A =
        { {contract1PDMSS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef   ].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+ 4].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+ 5].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+ 6].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70B =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef   ].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 7].pointer()},
          {contract1PDMSS.S().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+11].pointer()},
          {contract1PDMSS.S().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70C1 =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 1].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 2].pointer()},
          {contract1PDMSS.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+ 3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70C2 =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 4].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 5].pointer()},
          {contract1PDMSS.Z().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+ 6].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70D =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 8].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70E =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+13].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 9].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS70F =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+14].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71A =
        { {contract1PDMSS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+ 3].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+13].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+14].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71B =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef   ].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71C =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 7].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+11].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71D =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 6].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71G =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 8].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71E =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 4].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 1].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71I =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+14].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71F =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 5].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 2].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS71H =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 9].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+13].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72A =
        { {contract1PDMSS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+ 1].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+ 7].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+ 8].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+ 9].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72B =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef   ].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 7].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72C =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72D =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 4].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 1].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72G =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+14].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72E =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 6].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72H =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 8].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72F =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 5].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 2].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS72I =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 9].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+13].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73A =
        { {contract1PDMSS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+ 2].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+10].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+11].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+12].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73B =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef   ].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+11].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73C =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 7].pointer()},
          {contract1PDMSS.Y().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73D =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 5].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 2].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73G =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 9].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+13].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73E =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 6].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73H =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 8].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73F =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+ 4].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+ 1].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractSSSS73I =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.Z().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+14].pointer()} };
    ...
    if(this->hamiltonianOptions_.Gauge) {//Gauge
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2082 =
        { {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+6].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2083 =
        { {contract1PDMSS.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+7].pointer()},
          {contract1PDMSS.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+9].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+10].pointer()} };
     ...
     /* Equation (209) */
      std::vector<TwoBodyContraction<MatsT>> contractGLL209 =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer()},
          {contract1PDMSS.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2092 =
        { {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+6].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer()},
          {contract1PDMSS.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2093 =
        { {contract1PDMSS.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+13].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+15].pointer()},
          {contract1PDMSS.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL210 =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+2].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2102 =
        { {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer()},
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+5].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2103 =
        { {contract1PDMSS.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer()},  // changed here
          {contract1PDMSS.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+15].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL211 =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2112 =
        { {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+5].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2113 =
        { {contract1PDMSS.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer()},
          {contract1PDMSS.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+9].pointer()},
          {contract1PDMSS.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer()},
          {contract1PDMSS.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer()} };
    ...
    std::vector<TwoBodyContraction<MatsT>> contractGSS227 =
      { {contract1PDMLL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(),TRANS_MN_TRANS_KL} };
    ...
    std::vector<TwoBodyContraction<MatsT>> contractGSS2272 =
      { {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+6].pointer(),TRANS_MN_TRANS_KL} };
    ...
    std::vector<TwoBodyContraction<MatsT>> contractGSS2273 =
      { {contract1PDMLL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+7].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+9].pointer(),TRANS_MN_TRANS_KL},
        {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+10].pointer(),TRANS_MN_TRANS_KL} };
    ...
    MatAdd('N','N', NB1C, NB1C, iscale, Scr4, NB1C, MatsT(1.0), ss.exchangeMatrix->S().pointer()+SS, NB2C, ss.exchangeMatrix->S().pointer()+SS, NB2C);
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS228 =
        { {contract1PDMLL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2282 =
        { {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+6].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2283 =
        { {contract1PDMLL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+13].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+15].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS229 =
        { {contract1PDMLL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+2].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2292 =
        { {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+5].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2293 =
        { {contract1PDMLL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+15].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS230 =
        { {contract1PDMLL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2302 =
        { {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+5].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGSS2303 =
        { {contract1PDMLL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+9].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer(),TRANS_MN_TRANS_KL},
          {contract1PDMLL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer(),TRANS_MN_TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS232 =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+0].pointer()},
          {contract1PDMLS.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+1].pointer()},
          {contract1PDMLS.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+2].pointer()},
          {contract1PDMLS.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+3].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS2322 =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+0].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, COULOMB, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, COULOMB, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, COULOMB, relERI[nERIRef+3].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233AX =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+4].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233BX =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+17].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+18].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+19].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233CX =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+4].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233DX =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+17].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+18].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+19].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233AY =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+5].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233BY =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+20].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+21].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+22].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233CY =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+5].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233DY =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+20].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+21].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+22].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233AZ =
        { {contract1PDMLS.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+6].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233BZ =
        { {contract1PDMLS.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+23].pointer()},
          {contract1PDMLS.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+24].pointer()},
          {contract1PDMLS.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+25].pointer()} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233CZ =
        { {contract1PDMSL.S().pointer(), Scr1, true, COULOMB, relERI[nERIRef+6].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLS233DZ =
        { {contract1PDMSL.X().pointer(), Scr1, true, COULOMB, relERI[nERIRef+23].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr2, true, COULOMB, relERI[nERIRef+24].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr3, true, COULOMB, relERI[nERIRef+25].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL248 =
        { {contract1PDMSL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2482 =
        { {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2483 =
        { {contract1PDMSL.S().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+7].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+9].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+10].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL249 =
        { {contract1PDMSL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2492 =
        { {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+5].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2493 =
        { {contract1PDMSL.Z().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+13].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+10].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+15].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL250 =
        { {contract1PDMSL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2502 =
        { {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+4].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+5].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2503 =
        { {contract1PDMSL.X().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+11].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+8].pointer(), TRANS_KL},
          {contract1PDMSL.Y().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+15].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL251 =
        { {contract1PDMSL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+0].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+2].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+3].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+1].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2512 =
        { {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+5].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+6].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+4].pointer(), TRANS_KL} };
      ...
      std::vector<TwoBodyContraction<MatsT>> contractGLL2513 =
        { {contract1PDMSL.Y().pointer(), Scr1, true, EXCHANGE, relERI[nERIRef+12].pointer(), TRANS_KL},
          {contract1PDMSL.S().pointer(), Scr2, true, EXCHANGE, relERI[nERIRef+9].pointer(), TRANS_KL},
          {contract1PDMSL.X().pointer(), Scr3, true, EXCHANGE, relERI[nERIRef+14].pointer(), TRANS_KL},
          {contract1PDMSL.Z().pointer(), Scr4, true, EXCHANGE, relERI[nERIRef+16].pointer(), TRANS_KL} };
  ...
  void FourCompFock<MatsT,IntsT>::formGDDirect(SingleSlater<MatsT,IntsT> &ss,
    ...
    if(this->hamiltonianOptions_.BareCoulomb) { // DIRECT_COULOMB
      ...
      if(this->hamiltonianOptions_.Libcint) {
        ...
        std::vector<TwoBodyContraction<MatsT>> contractLL =
          { {contract1PDMLL.S().pointer(), CScrLLMS, true, BARE_COULOMB},
        ...
        // Call the contraction engine to do the assembly of Dirac-Coulomb LLLL
        relERICon.twoBodyContract(ss.comm, true, contractLL,pert);
        ...
        std::vector<TwoBodyContraction<MatsT>> contractLL =
          { {contract1PDMLL.S().pointer(), CScrLLMS, true, COULOMB} };
    ...
    if(this->hamiltonianOptions_.DiracCoulomb) { // DIRAC_COULOMB
      ...
      std::vector<TwoBodyContraction<MatsT>> contractDCLL =
        { {contract1PDMLL.S().pointer(), CScrLLMS, true, LLLL},
          {contract1PDMLL.S().pointer(), XScrLLMS},
          {contract1PDMLL.X().pointer(), XScrLLMX},
          {contract1PDMLL.Y().pointer(), XScrLLMY},
          {contract1PDMLL.Z().pointer(), XScrLLMZ},
      ...
      std::vector<TwoBodyContraction<MatsT>> contractDCLS =
        { {contract1PDMLL.S().pointer(), CScrLLMS, true, LLSS},
          {contract1PDMLL.S().pointer(), XScrLLMS},
          {contract1PDMLL.X().pointer(), XScrLLMX},
          {contract1PDMLL.Y().pointer(), XScrLLMY},
          {contract1PDMLL.Z().pointer(), XScrLLMZ},
    ...
    if(this->hamiltonianOptions_.DiracCoulombSSSS) { // SSSS
      ...
      std::vector<TwoBodyContraction<MatsT>> contractDCSS =
        { {contract1PDMLL.S().pointer(), CScrLLMS, true, SSSS},
          {contract1PDMLL.S().pointer(), XScrLLMS},
          {contract1PDMLL.X().pointer(), XScrLLMX},
          {contract1PDMLL.Y().pointer(), XScrLLMY},
          {contract1PDMLL.Z().pointer(), XScrLLMZ},
    ...
    if(this->hamiltonianOptions_.Gaunt) { // Gaunt
      ...
      std::vector<TwoBodyContraction<MatsT>> contractDCGaunt =
        { {contract1PDMLL.S().pointer(), CScrLLMS, true, GAUNT},
  	  //
          {contract1PDMLL.S().pointer(), XScrLLMS},
          {contract1PDMLL.X().pointer(), XScrLLMX},
          {contract1PDMLL.Y().pointer(), XScrLLMY},
    ...
    if(this->hamiltonianOptions_.Gauge) { // Gauge
      ...
      std::vector<TwoBodyContraction<MatsT>> contractDCGauge =
        { {contract1PDMLL.S().pointer(), CScrLLMS, true, GAUGE},
          //
          {contract1PDMLL.S().pointer(), XScrLLMS},
          {contract1PDMLL.X().pointer(), XScrLLMX},
          {contract1PDMLL.Y().pointer(), XScrLLMY},
